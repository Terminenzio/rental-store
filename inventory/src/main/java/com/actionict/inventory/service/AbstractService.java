...
public abstract class AbstractService<E extends BaseEntity<ID>, ID> implements EntityService<E, ID> {

//    @Autowired
//    private final CountryRepository entityRepository;
    protected final JpaRepository<E, ID> entityRepository;

    public AbstractService(JpaRepository<E, ID> entityRepository) {
...
//        existing.setName(entity.getName());
    ...
    @Transactional
    @Override
    public E partialUpdate(ID id, Map<String, Object> updates) {
